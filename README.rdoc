...
Authors and other end users should download the re-distributable packages available at http://www.napcs.com/products/docbook which are more stable.
...
And set your ENV variable for SHORT_ATTENTION_SPAN_DOCBOOK to point there. You may also wish to add ~/docbook_edge to your path.
...
=== More Usage
This package can create EPUB files too. And while RTF files will build, the support here is pretty weak. I'm working on that.
 ...
 * Tested ePub output on iBooks 1.2 and Stanza on the iPad.
2010-09-00 -v1.3.0.3
